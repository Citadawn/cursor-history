...
import {
  DatabaseLockedError, isDatabaseLockedError,
  DatabaseNotFoundError, isDatabaseNotFoundError,
  InvalidConfigError, isInvalidConfigError,
  InvalidFilterError, isInvalidFilterError,
  SessionNotFoundError, isSessionNotFoundError,
  WorkspaceNotFoundError, isWorkspaceNotFoundError,
  SameWorkspaceError, isSameWorkspaceError,
  NoSessionsFoundError, isNoSessionsFoundError,
  DestinationHasSessionsError, isDestinationHasSessionsError,
  NestedPathError, isNestedPathError,
  BackupError, isBackupError,
  NoDataError, isNoDataError,
  FileExistsError, isFileExistsError,
  InsufficientSpaceError, isInsufficientSpaceError,
  RestoreError, isRestoreError,
  BackupNotFoundError, isBackupNotFoundError,
  InvalidBackupError, isInvalidBackupError,
  TargetExistsError, isTargetExistsError,
  IntegrityError, isIntegrityError,
...
describe('type guards', () => {
  const guards = [
    { guard: isDatabaseLockedError, instance: new DatabaseLockedError('p'), name: 'isDatabaseLockedError' },
    { guard: isDatabaseNotFoundError, instance: new DatabaseNotFoundError('p'), name: 'isDatabaseNotFoundError' },
    { guard: isInvalidConfigError, instance: new InvalidConfigError('f', 'v', 'r'), name: 'isInvalidConfigError' },
    { guard: isInvalidFilterError, instance: new InvalidFilterError([], []), name: 'isInvalidFilterError' },
    { guard: isSessionNotFoundError, instance: new SessionNotFoundError('x'), name: 'isSessionNotFoundError' },
    { guard: isWorkspaceNotFoundError, instance: new WorkspaceNotFoundError('p'), name: 'isWorkspaceNotFoundError' },
    { guard: isSameWorkspaceError, instance: new SameWorkspaceError('p'), name: 'isSameWorkspaceError' },
    { guard: isNoSessionsFoundError, instance: new NoSessionsFoundError('p'), name: 'isNoSessionsFoundError' },
    { guard: isDestinationHasSessionsError, instance: new DestinationHasSessionsError('p', 1), name: 'isDestinationHasSessionsError' },
    { guard: isNestedPathError, instance: new NestedPathError('a', 'b'), name: 'isNestedPathError' },
    ...
    { guard: isInsufficientSpaceError, instance: new InsufficientSpaceError(1, 0), name: 'isInsufficientSpaceError' },
    { guard: isRestoreError, instance: new RestoreError('msg'), name: 'isRestoreError' },
    { guard: isBackupNotFoundError, instance: new BackupNotFoundError('p'), name: 'isBackupNotFoundError' },
    { guard: isInvalidBackupError, instance: new InvalidBackupError('p', 'r'), name: 'isInvalidBackupError' },
    { guard: isTargetExistsError, instance: new TargetExistsError('p'), name: 'isTargetExistsError' },
